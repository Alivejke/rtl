    ...
    <React.Fragment>
      <article className="show">
        ...
        <div className="show__info">
          <h2 className="show__title">{show.name}</h2>
          <p
        ...
        <div className="show__card">
          ...
          <ul className="show__card-list">
            <li className="show__card-list-item">
              <span className="show__card-list-title">Network:</span>
              <span className="show__card-list-descr">{show.network.name}</span>
            </li>
            <li className="show__card-list-item">
              <span className="show__card-list-title">Genres:</span>
              <span className="show__card-list-descr">
                {show.genres.join(", ")}
              </span>
            </li>
            <li className="show__card-list-item">
              <span className="show__card-list-title">Status:</span>
              <span className="show__card-list-descr">{show.status}</span>
            </li>
            <li className="show__card-list-item">
              <span className="show__card-list-title">Show Type:</span>
              <span className="show__card-list-descr">{show.type}</span>
            </li>
          </ul>
        </div>
      </article>
