...
import { episodes as edisodesSchema, episode as edisodeSchema } from "../../api/tvmaze/schema";
...
export const makeGetEpisodesByShow = (id) => createSelector(
...
export const makeGetEpisode = (id) => createSelector(
  (state) =>  state.episodes.entities,
  (entities) => {
